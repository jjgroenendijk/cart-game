...
export const SNOW_DEFAULTS = {
  ...
  patchScale: 0.06,
  /** Sparkle glint strength added to lit snow (0 disables). Scene-linear HDR is
   *  retained so ACES rolls the sparse points into bright, localized glitter.
   *  Tier-gated off on low via the SNOW_SPARKLE define. */
  sparkle: 1.2,
