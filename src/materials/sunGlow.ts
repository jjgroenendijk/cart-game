 ...
 *
 * The effects are source-specific additive sRGB terms in the final
 * SkyPosterizePass (post-tonemap). They deliberately replace scene-wide HDR
 * bloom: the raw sky dome and ordinary sunlit surfaces both exceed linear 1.0,
 * so a global luminance threshold creates a full-frame veil. Each analytic
 * term stays capped and independently switchable via an effectGain a Settings
