...
An enchanted fairy-tale wood at the turn of the season: golden/red/gold
canopy, soft mystical light, drifting leaf-fall, a mossy floor under dense
trees. This mood belongs to autumn alone.

Art style + vibe guide (the contract for palette, mood, and future
per-biome music/audio): `docs/knowledge/biomes/autumn.md`. Framework rules:
`../AGENTS.md`; wiki index: `@docs/knowledge/biomes/index.md`.

## Directory Map

```text
./src/environment/biomes/autumn/
...
flowchart LR
  ...
  vibe[vibe guide docs/knowledge/biomes/autumn.md] --> art[palette + mood]
