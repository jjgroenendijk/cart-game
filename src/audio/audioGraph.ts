...
import { RainVoice, WeatherWindVoice } from "./rainVoice";
...
export function startPersistentVoices(
  ...
  const weatherWind = new WeatherWindVoice(ctx, noise, sfxBus);
  ...
  return { noise, voices, panners, wind, rain, weatherWind, musicEngine, collision, rivals };
}
