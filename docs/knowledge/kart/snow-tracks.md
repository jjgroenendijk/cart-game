...
type: Subsystem
title: Snow Tracks
description: Living depth-profiled snow tire tracks as a shaded berm/channel strip on layer 1.
...
layer 1. Each rear-wheel segment is a groove: a shadowed CENTER channel flanked
...
- vertex colors: bright cool-white berms, blue-grey channel (darker base) ->
  the channel reads sunken.
