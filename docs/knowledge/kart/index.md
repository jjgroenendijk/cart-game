...
- [kart-mesh](/kart/kart-mesh.md) — Procedural kart mesh, visual sync, chase camera, and LOD
- [vfx](/kart/vfx.md) — GPU particle effects: dust, drift smoke, splash, respawn poof
- [kart-variants](/kart/kart-variants.md) — Six kart archetypes with tuning,
  silhouette, colorway, and stat bars
