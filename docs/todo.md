# Game Cart — visual/audio/menu overhaul backlog

Visual overhaul: cartoony cel-shaded world, procedural sky, height variation,
...
002 implemented + typecheck clean, pending human visual review.
003-006 not started.
